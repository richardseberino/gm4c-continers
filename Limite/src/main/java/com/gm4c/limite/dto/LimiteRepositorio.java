...
public interface LimiteRepositorio extends CassandraRepository<LimiteDto, String>{
	...
	List<LimiteDto> pesquisaLimite(@Param("agencia") int agencia, @Param("conta") int conta, @Param("dv") int dv, @Param("valor_limite") double valor_limite, @Param("valor_utilizado") double valor_utilizado);
